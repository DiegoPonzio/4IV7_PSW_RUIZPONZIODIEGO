...
public class ModificarAlumno extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ((request.getParameter("dato").equals("bol")) && Integer.parseInt(request.getParameter("modificar")) > 0) {
                try {
                ...
                int bandera2 = 1;
                try {
                    double d = Double.parseDouble(cambio);
                    if (d % 2 == 0 || d % 2 == 1) {
                        bandera = 2;
                    } else {
                        bandera = 2;
                ...
                if (bandera == 1 && !(request.getParameter("dato")).equals("telefono")) {
                    try {
                        bol = Double.parseDouble(request.getParameter("modificar"));
                ...
                set.close();*/
                    ...
                    if ((request.getParameter("dato")).equals("telefono") && bandera == 2) {
                        try {
                            bol = Double.parseDouble(request.getParameter("modificar"));
                ...
                set.close();*/
                            ...
                            out.println("<h1>Error:</h1>"
                                    + "<br>"
                                    + "<p>EL dato ingresado no es aceptado por el dato que intenta ingresar</p>");
                    }
                }
            }
            out.println("<br>"
                    + "<a href= ConsultarAlumnos>Consultar tabla de alumnos Bátiz</a>"
                    + "<br>");
